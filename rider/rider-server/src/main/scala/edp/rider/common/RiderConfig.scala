...
object RiderConfig {
  ...
  lazy val wormholeJarPath = getStringConfig("spark.wormhole.jar.path", s"${RiderConfig.riderRootPath}/app/wormhole-ums_1.3-sparkx_2.4-0.6.2-jar-with-dependencies.jar")
  lazy val wormholeKafka08JarPath = getStringConfig("spark.wormhole.kafka08.jar.path", s"${RiderConfig.riderRootPath}/app/wormhole-ums_1.3-sparkx_2.4-0.6.2-jar-with-dependencies-kafka08.jar")
  lazy val kafka08StreamNames = getStringConfig("spark.wormhole.kafka08.streams", "")
  lazy val sparkxInterfaceJarPath = getStringConfig("spark.wormhole.sparkxinterface.jar.path", s"${RiderConfig.riderRootPath}/app/wormhole-sparkxinterface-0.6.2.jar")
  ...
  lazy val flink = RiderFlink(config.getString("flink.home"), config.getString("flink.yarn.queue.name"), getBooleanConfig("flink.feedback.enabled", false), getIntConfig("flink.feedback.state.count", 100), getIntConfig("flink.feedback.interval", 30), 1, 1,
    getStringConfig("flink.wormhole.jar.path", s"${RiderConfig.riderRootPath}/app/wormhole-ums_1.3-flinkx_1.7.2-0.6.2-jar-with-dependencies.jar"),
